...
type IntentResponse<T = PlainObject> = {
...
export default class Api {
    ...
    request<T extends IntentType>(intent: string, data: T['request'], options?: PlainObject): Promise<AxiosResponse<IntentResponse<T['response']>>> {
